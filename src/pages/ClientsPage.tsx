    ...
    <AppLayout activeRoute="clients">
      <div className="p-6 md:p-12 max-w-5xl mx-auto w-full">
        <header className="mb-12">
          ...
          <p className="text-brand-stone font-light">Sua base de contatos e histórico de atendimentos.</p>
        </header>

        {/* Stats Row */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
          <div className="bg-brand-white p-6 rounded-[32px] border border-brand-mist shadow-sm">
            <p className="text-[10px] font-medium text-brand-stone uppercase tracking-widest mb-1">Total de Clientes</p>
            <p className="text-3xl font-serif text-brand-ink">{clients.length}</p>
          </div>
          <div className="bg-brand-white p-6 rounded-[32px] border border-brand-mist shadow-sm">
            <p className="text-[10px] font-medium text-brand-stone uppercase tracking-widest mb-1">Clientes Frequentes</p>
        ...
        <div className="space-y-4">
          {loading ? (
            <AppLoadingScreen fullScreen={false} message="Carregando clientes..." />
            ...
            <div className="text-center py-20 md:py-32 bg-brand-white/50 rounded-[40px] border border-dashed border-brand-mist px-6">
              ...
              <p className="text-brand-stone font-serif italic text-lg font-light mb-2">Sua lista de clientes começará aqui.</p>
              <p className="text-[10px] text-brand-stone uppercase tracking-widest max-w-xs mx-auto">Seus clientes aparecerão aqui conforme você agendar e atender.</p>
            </div>
          )}
        </div>
      </div>
