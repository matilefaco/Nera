...
async function sendClientRescheduleProfessionalEmailFailSoft(appointmentId: string, previousDate: string, previousTime: string, updatedData: any): Promise<void> {
