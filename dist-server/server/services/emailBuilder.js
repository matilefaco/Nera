...
export function buildEmailBase(options) {
    const { topbarText, heroVariant, heroLabel, heroTitle, heroTitleItalic, badgeText, badgeVariant = 'info', bodyHtml, ctaText, ctaUrl, ctaSubtext, footerLinksHtml, unsubscribeUrl, showUnsubscribe, } = options;
...
export function buildEmailCard(items) {
    return `
