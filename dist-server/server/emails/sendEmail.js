...
export async function sendReviewRequestEmail(data) {
    ...
    if (!clientEmail || !data.reviewUrl)
        return { success: false, error: 'Email or URL missing' };
    const formattedDate = new Date(data.date + 'T00:00:00').toLocaleDateString('pt-BR', {
 ...
 */
export async function sendBookingReminder24hEmail(data) {
 ...
 */
export async function sendConfirmationRequest24hEmail(data) {
 ...
 * EVENT: retention_30d
 */
export async function sendRetentionEmail(data) {
...
export async function sendWaitlistInviteEmail(data) {
    const { clientName, clientEmail, professionalName, date, time, bookingUrl, serviceName, servicePrice, expiresInHours, isExclusive, appointmentId } = data;
 ...
 */
export async function sendTrialWillEndEmail(data) {
