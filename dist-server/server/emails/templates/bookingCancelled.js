...
export function buildBookingCancelledEmail(data) {
    const { professionalName, clientName, serviceName, formattedDate, time, waitlistUrl, cancellationReason, waitlistCount, profileUrl } = data;
