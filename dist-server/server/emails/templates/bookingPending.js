...
export function buildBookingPendingEmail(data) {
    const { professionalName, serviceName, formattedDate, time, price, reservationCode, manageUrl, whatsappUrl, clientName } = data;
    const bodyHtml = `
